class FarmWorker::Job::Render < Job
  def run
    ...
    blender_command = "/home/ec2-user/blender/blender --background #{project_cache.local_project_blendfile} --use-extension 1 -noaudio -E CYCLES -t 0 -o #{output_dir}/ -F PNG -f #{frame}"
